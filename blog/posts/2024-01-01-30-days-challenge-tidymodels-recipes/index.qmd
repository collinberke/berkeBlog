...
So, it only seems `step_input_mode()` can only be used to impute missing values for nominal variables. 
...
As always, let's bake this recipe and look at the final data, which should not have any missing data.
