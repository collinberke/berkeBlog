...
Much of this taken place using GitHub's command line tool: [`gh`](https://cli.github.com/).
I wanted to learn more, since I began to see the usefulness of this tool.
The goal, then, was to identify ways I could be more productive using GitHub's search.
...
Search allows you to navigate and find almost anything availabe within GitHub.
...
For instance, search can be targetted at specific organizations or repositories you own.
...
I won't spend much time overviewing all of these, but I will hightlight some of them throughout this post, especially ones that are useful for search.
...
Or, you can make the search more localized, say by targetting a specific repo.
...
The possiblities are endless here when it comes to searching code within GitHub.
